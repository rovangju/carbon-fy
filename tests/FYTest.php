...
class FYTest extends TestBase {
    ...
    public function data() {
        return array(
            ...
            array(1, 1, '2015-01-02', '2015-01-01'),

            array(7, 1, '2015-01-01', '2015-07-01'),
            array(7, 1, '2015-06-29', '2015-07-01'),

            /* Actual year + 1 */
            /*    M, D, 'test value', 'expected  ' */
            array(7, 1, '2015-07-01', '2016-07-01'),
            array(7, 1, '2015-07-01', '2016-07-01'),
            array(12, 30, '2015-12-31', '2016-12-30')
        );
    }
